...
public class PermissionUtils {
    ...
    public static final int REQUEST_CONTACTS_CODE_FOR_ADD_CONTACT = 7;
    public static final int REQUEST_CONTACTS_CODE_FOR_GO_TO_CONTACT = 8;
    public static final int REQUEST_CONTACTS_CODE_FOR_GO_TO_TIME_LINE = 9;
    public static final int REQUEST_MICROPHONE_CODE_WHEN_ANSWER = 10;
    public static final int REQUEST_CONTACTS_CODE_FOR_NEW_CONTACT = 11;
